...
Removing the AutoLinkMask set by `autoLink="email|phone"` resolved the issue, but removed the builtin email/phone link handling. Looking to alternative solution. 
  ...
  Ideally, a second click event shouldn't be fired.
